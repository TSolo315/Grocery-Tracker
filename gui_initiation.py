...
class MainGUI:
    ...
    def submit_item_entry(self):
        ...
        self.transaction_dict.setdefault(item_name, [item_price, item_quantity, item_category, weight_based_price])
    ...
    def submit_transaction(self,):
        ...
        for key, value in self.transaction_dict.items():
            ...
            transaction_list.append(group_listing)
        for i in transaction_list:
            if i[0] in self.name_list:
                self.DBM.update_product(i)
            else:
                self.DBM.push_product(i)
        self.DBM.save()
